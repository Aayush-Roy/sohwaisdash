...
console.log("prod", productList);
  ...
  useEffect(() => {
  setVisibleCount(10);
}, [searchTerm, selectedCategory, selectedCollection, selectedStatus]);
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            {filteredProducts.length === 0 ? (
              ...
              <div className="overflow-x-auto">
                ...
                <Table columns={columns} data={filteredProducts.slice(0, visibleCount)} />
                {visibleCount < filteredProducts.length && (
  <div className="text-center py-6">
    <Button
      onClick={() => setVisibleCount(prev => prev + 10)}
      className="bg-royalBrown hover:bg-royalBrown/90 px-8"
    >
      Load More Products
    </Button>
  </div>
